...
@app.route("/login")
def login():
    scope = "user-read-recently-played user-read-playback-state user-read-email user-library-read playlist-modify-public playlist-modify-private playlist-read-private user-library-modify user-read-currently-playing user-modify-playback-state"
    params = {
        "client_id": CLIENT_ID,
        "response_type": "code",
        "scope": scope,

        ...
        <>
            <div className="about">
                ...
                <ol className='about-text'>
                    ...
                    <li>Close Playlist Sifter and start listening to music how you normally would.</li>
                ...
                <p className='about-subtitle'>How can I remove Playlist Sifter's access to my Spotify account?</p>
                <p className='about-text'>You can remove Playlist Sifter's access to your Spotify account by visiting <a href="https://www.spotify.com/us/account/apps/">spotify.com/us/account/apps/</a> and clicking "Remove Access" next to Playlist Sifter.</p>
            </div>
        </>
    );
}
